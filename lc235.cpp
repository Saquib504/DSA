...
int main() {
    ...
    int p, q; cout << "Enter the value of p and q whose you want to find the LCA in the BST(p and q should be present in the BST): "; cin >> p >> q;


    cout << "The LCA of " << p << " and " << q <<  " is : " << lowestCommonAncestor(root, p, q) << endl;
